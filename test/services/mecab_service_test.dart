...
void main() {
  group('MecabServiceTest', () {
    ...
    test('createRubyTextPairs convertReading set to false', () {
      var pairs = service.createRubyTextPairs(
        '周り',
        'まわり',
      ...
      pairs = service.createRubyTextPairs(
        '川',
        'かわ',
        convertReading: false,
      );
    ...
    test('createRubyTextPairs mismatched writing and reading', () {
      ...
      pairs = service.createRubyTextPairs('周り', 'まわた', convertReading: false);
      expect(pairs.length, 1);
      expect(pairs[0].writing, '周り');
      expect(pairs[0].reading, 'まわた');
      ...
      pairs = service.createRubyTextPairs('周り', 'まわりた', convertReading: false);
      expect(pairs.length, 1);
      expect(pairs[0].writing, '周り');
      expect(pairs[0].reading, 'まわりた');
      ...
      pairs = service.createRubyTextPairs('周りた', 'まわり', convertReading: false);
      expect(pairs.length, 1);
      expect(pairs[0].writing, '周りた');
      expect(pairs[0].reading, 'まわり');
